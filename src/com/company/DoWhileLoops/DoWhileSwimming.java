...
}       //Yes they swam for the same amount of time (4min)
        // If i enter 78 gallant swims for 0 min
        // GOOFUS swims for 1 min

        // These 2 loops are different because of the fact that in the do...while loop it executes
        // the code block at least once even if the condition is not met. The normal while loop
        //only executes when the condition is met

        // The second one is the pre-test loop the first one is the post-test.
